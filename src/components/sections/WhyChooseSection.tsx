...
export const WhyChooseSection = () => {
  return (
    ...
    >
      {/* Diagonal stripes layered on top */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          >
            <Quote
              size={48}
              className="text-secondary absolute -top-4 -left-4 bg-primary p-2 rounded-full"
            />
          ...
          >
            ...
            <ul className="space-y-5">
              {whyChooseContent.points.map((item, index) => (
                ...
                >
                  <span className="shrink-0 w-12 h-12 rounded-full bg-white/10 backdrop-blur border-2 border-secondary/60 flex items-center justify-center font-display text-secondary text-lg font-bold transition-all duration-300 group-hover:bg-secondary group-hover:text-primary">
