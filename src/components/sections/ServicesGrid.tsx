            ...
            return (
              ...
              >
                ...
                >
                  ...
                  />
                  {/* Gradient overlay — eggplant to transparent */}
                  <div
                    className="absolute inset-0 transition-opacity duration-500"
                    style={{
                      background:
                        "linear-gradient(to top, rgba(26,15,38,0.95) 0%, rgba(59,31,79,0.55) 50%, rgba(190,52,85,0.10) 100%)",
                    }}
                  />
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                    ...
                    <div className="mt-3 flex items-center gap-2 text-secondary text-xs font-bold uppercase tracking-widest opacity-100 group-hover:opacity-100">
