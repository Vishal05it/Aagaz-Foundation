...
export const AboutSection = () => {
  return (
    <section id="about" className="py-32 px-6 max-w-7xl mx-auto relative bg-stripes-warm">
      <div className="flex flex-col md:flex-row items-center relative">
        ...
        >
          <div className="w-full h-full bg-primary/10 absolute inset-0 -z-10 transform translate-x-12 translate-y-12" />
